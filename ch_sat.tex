...
%%%%%%%%%%%%% figure
\begin{figure}[htb]
\centerline{\includegraphics[width=\textwidth]{FIGURES/CH3/missions.pdf}}
%\vspace{3.64in}
...
%%%%%%%%%%%%% figure
\begin{figure}[htb]
\centerline{\includegraphics[width=0.9\textwidth]{FIGURES/CH3/dessin_footprint.pdf}}
%\vspace{3.64in}
...
It should be noted that the main application of the altimeters was the mapping of the sea surface height (SSH) for the determination of the geoid, tides and dynamical topography. The measured
 ...
 %%%%%%%%%%%%% figure
\begin{figure}[htb]
\centerline{\includegraphics[width=\textwidth]{FIGURES/CH3/altimetre_cartes2011.pdf}}
%\vspace{3.64in}
...
%%%%%%%%%%%%% figure
\begin{figure}[htb]
\centerline{\includegraphics[width=0.8\textwidth]{FIGURES/dessin_fig1_landscape.pdf}}
%\vspace{3.64in}
...
%%%%%%%%%%%%% figure
\begin{figure}[!h]
\centerline{\includegraphics[width=0.8\textwidth]{FIGURES/CH3/Image_SAR_Cancale2.png}}
...
%%%%%%%%%%%%% figure
\begin{figure}[htb]
\centerline{\includegraphics[width=\textwidth]{FIGURES/SWOTSWELL.pdf}}
...
%%%%%%%%%%%%% figure
\begin{figure}[htb]
\centerline{\includegraphics[width=0.4\textwidth]{FIGURES/CFOSAT_v2.pdf}}
...
%%%%%%%%%%%%% figure
\begin{figure}[htb]
\centerline{\includegraphics[width=0.73\textwidth]{FIGURES/CH3/wamos_en.png}}
