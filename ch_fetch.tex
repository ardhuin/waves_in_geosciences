...
are superimposed, as given by Kahma and Calkoen (1992), and Kahma (1981) from other datasets, and 
...
wave growth formulae \citep{Elfouhaily&al.1997} that can be closely approximated by 
\begin{eqnarray}
...
%\vspace{3.64in}
  \caption{Example of proposed parametric wave spectrum shapes, for $U_{10}=10$~m~s$^{-1}$ and $X=50$~km. Left: using a linear scale and 
